...
urlpatterns = [
    ...
    url(r'^account/verification/(?P<verification_code>\w+)/$', views.email_verification, name='emailVerification'),
    ...
    url(r'^activity/delete-activity/$', views.deleteactivity, name='deleteactivity'),
    url(r'^activity/edit-activity/(?P<performs_id>[0-9]+)/$', views.editactivity, name='editactivity'),
    url(r'^activity/update-activity/$', views.updateactivity, name='updateactivity'),
    url(r'^activity/listallactivities/$', views.listallactivities, name='listallactivities'),
    url(r'^index/$', views.index, name='index'),
    url(r'^index/(?P<user_type>\w+)$', views.index, name='index'),
