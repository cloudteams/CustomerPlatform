...
urlpatterns = [
    ...
    url(r'^calendar/$', views.index, name='calendar'),
    url(r'^calendar/eventstojson/$', views.eventstojson, name='json-events'),
    url(r'^calendar/chartdatajson/$', views.chartdatajson, name='chartdatajson'),
    url(r'^calendar/displayperiod/$', views.displayperiod, name='displayPeriod'),
    url(r'^calendar/fetch_tokenfield_values/$', views.fetch_tokenfield_values, name='fetchTokenfieldValues'),
    url(r'^calendar/getgroupedactivities/$', views.getgroupedactivities, name='getgroupedactivities'),
