...
class YoutubeOAuth2(BaseGoogleOAuth2API, BaseOAuth2):
    """Youtube OAuth2 authentication backend"""
    name = 'youtube'
    ...
    DEFAULT_SCOPE = ['email', 'https://www.googleapis.com/auth/youtube.readonly']
